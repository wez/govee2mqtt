...
- Add Govee H60B0 (Neon Rope Light 2) support ([#5](https://github.com/homeassilol/govee2mqtt/pull/5))
...
- Update documentation for recent fork changes ([#6](https://github.com/homeassilol/govee2mqtt/pull/6))
